#!/bin/bash
echo ${XL_IDP_ROOT}
xls_path="${XL_IDP_ROOT}/lines_${XL_IMPORT_TERMINAL}/evergreen/"
#xls_path=/home/timur/Anton_project/import_xls-master/НУТЭП\ -\ ноябрь/Evergreen
echo "$xls_path"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ../scripts_for_bash_with_inheritance/evergreen.py "${csv_name}" "${json_path}"
