echo ${XL_IDP_ROOT}
xls_path="${XL_IDP_ROOT}/lines_${XL_IMPORT_TERMINAL}/msc/"
echo $xls_path

# xls_path=/home/ruscon/Import_xls/MSC_НУТЭП_ДЕК.2020/
mkdir "${xls_path}"/csv
mkdir "${xls_path}"/json
...
do
    ...
    python3 ../scripts_for_bash/"msc.py" "${csv_name}" "${xls_path}"/json
