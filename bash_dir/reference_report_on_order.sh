#!/bin/bash
echo ${XL_IDP_ROOT}
xls_path="${XL_IDP_ROOT}/reference_report_on_order"
#xls_path=/home/timur/Anton_project/import_xls-master/reference_report_on_order
echo "$xls_path"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ../scripts_for_bash_with_inheritance/reference_report_on_order.py "${csv_name}" "${json_path}"
